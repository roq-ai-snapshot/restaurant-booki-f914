...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Restaurant booking engine v8`}</title>

        <meta
          name="description"
          content="Experience seamless dining with Restaurant Booking Engine v8 - Your ultimate solution for efficient table reservations and menu management."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Restaurant booking engine v8`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless dining with Restaurant Booking Engine v8 - Your ultimate solution for efficient table reservations and menu management.`}
            </Text>
            <Box
